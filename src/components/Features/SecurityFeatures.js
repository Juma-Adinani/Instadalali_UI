...
const SecurityFeatures =()=>{
    return (
      <section className="h_security_area" style={{ background: `#385a5d` }}>
        <div className="container">
          <div className="hosting_title security_title text-center">
            <h2 className="wow fadeInUp" data-wow-delay="0.2s">
              <h2 style={{ color: `white` }}>What the App Do ?.</h2>
            </h2>
          </div>
          <div className="row">
            <SecurityFeaturesItem
              ...
              pText="a 3D virtual tours within the App or using VR headset by paying a visit to our office or agents"
            />
            <SecurityFeaturesItem
              itemClass="pl_70"
